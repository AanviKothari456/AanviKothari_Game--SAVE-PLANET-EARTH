...
function draw() {
  ...
  if(gameState ==="end"){ 
    ...
    fill('red');
    textSize(25);
    text('GO AGAIN TO SAVE THE EARTH', windowWidth/2-100, windowHeight/2+100);
    man.visible = false;
 ...
 if(gameState ==="win"){ 
  man.destroy();
       ...
       bg.destroy();
        background(0);
        textSize(30);
        text(' YOU SUCCESSFULLY SAVED THE EARTH!', windowWidth/2-500, windowHeight/2)
}
}
...
function gwCollection(){
   ...
   function Questions(){
    ...
    switch(gameState){
      case "level1":    
                         textSize(25);
                        text(' Do you think that inequalities like gender and cultural identity should affect education’s reach?', windowWidth/2-500,200);
                        problem.visible=false;
                        yes.visible = true;
                        no.visible = true;
      ...
      case "level2": 
      textSize(25);
      text('If you met a stranger on the road who is looking for a job, would you reference him/her to a potential employee you know of?', windowWidth/2-700,250);
      yes.visible = true;
      no.visible = true;
      problem.visible=false;
    ...
    break;
      case "level3": 
      textSize(25);
      text(' Do you believe in reusing materials like newspaper and other scraps and wish to spread awareness about pollution?', windowWidth/2-700,250);
      yes.visible = true;
      no.visible = true;
      problem.visible=false;
      if(mousePressedOver(no)){
    ...
    break;
      case "level4": textSize(25);
      text("Do you think that you should obey sanitation rules during a pandemic if others aren't? ", windowWidth/2-500,250);
      yes.visible = true;
      no.visible = true;
      problem.visible=false;
      if(mousePressedOver(no)){
    ...
    break;
      case "level5": textSize(25);
      text(' Do you think switching off your lights and fans and reducing water waste can prevent pollution?', windowWidth/2-600,250);
      yes.visible = true;
      no.visible = true;
      problem.visible=false;
      if(mousePressedOver(yes)){
    ...
    unempGroup.visible = false;
    pollGroup.visible = false;
    pandGroup.visible = false;
    gwGroup.visible = false;*/
